...
import (
	"book-srv/config/api"
	bookBean "book-srv/modules/book/bean"
	stations2 "book-srv/modules/sysinit/stations"
	"encoding/json"
	"errors"
	"fmt"
...
func submitOrder(conversation *conversation.Conversation, bookResult *bookBean.BookResult) (err error) {
	...
	data.Set("query_from_station_name", stations2.GetStationValueByKey(bookResult.SelectTran.FindFrom))
	data.Set("query_to_station_name", stations2.GetStationValueByKey(bookResult.SelectTran.FindTo))
	data.Set("undefined", "")
...
func getPassenger(method string, conversation *conversation.Conversation, GlobalRepeatSubmitToken string) (Passenger bool, pData bookBean.PresenterVa, err error) {
